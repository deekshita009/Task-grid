...
function loadtasks(table) {
    $.post('api.php', { action: 'readtasks' }, function(res) {
...
$('#dept').on('change', function(){
    if($('#dept').val()!=''){
    $.post('api.php', {action:'filterfaculty', dept:$('#dept').val()}, function(res){
...
$('#fwdform').on('submit', function(e) {
    ...
    $.post('api.php', { action: 'forward', taskId: taskid, name: faculty }, function(res) {
        console.log(res); 
...
function editstatus(id){   
    Swal.fire({
        ...
        if(result.isConfirmed){
            $.post('api.php', {action:'update_status', status:'Completed', task_assignment_id: id}, function(res){
